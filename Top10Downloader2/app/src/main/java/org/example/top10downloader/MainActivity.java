...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnParse.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean operationStatus = parse.testProcess();
                if (operationStatus) {
    ...
    //region PRACTICE_CODE
    /*Asynchronous class*/
    /*1st one is the url, progress,what we are going to return back*/
    ...
    private class DownloadXmlData extends AsyncTask<String, Void, String> {
        ...
        private String downloadXMl(String theUrl) throws IOException {
            ...
            try {
                ...
                Log.d("DownloadXML", "The response returned is :" + responseCode);
                ...
                /*remember irs already have inputstream and it's reading it and and char[] array must be passed to read to the limit
                * of the given size the trick is here we declared BUFFER_SIZE
                * */
                /*Buffer size how much data will be used to read at a time...need to know more*/
                try {
                    while ((charRead = irs.read(inputBuffer)) > 0) {
                        String readString = String.copyValueOf(inputBuffer, 0, charRead);
                        xmlContents += readString;
                        inputBuffer = new char[BUFFER_SIZE];
                    }
